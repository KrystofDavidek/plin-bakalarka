...
Předkládána bakalářská práce se zabývá aplikační rovinou slovní derivace. Cílem práce je navrhnout a implementovat elektronický slovník s definicemi založenými na derivačních rysech slovotvorně motivovaných slov ve formě mobilní aplikace. Teoretická část se zabývá problematikou české slovotvorby -- jsou zde představeny hlavní synchronní přístupy a je zde popsáná onomaziologická teorie slovotvorby, na které je postaven výsledný nástroj. V praktické části je popsán proces vytváření slovníkových definic a rozebrán návrh spolu s implementací mobilní aplikace. Nástroj využívá volně přístupných dat z derivační sítě DeriNet a jeho primárním účelem je sloužit jako podpůrný prostředek pro výuku češtiny jako druhého jazyka.

\section*{Abstract}

This bachelor thesis is concentrating on the application level of word derivation. The purpose of the thesis is to design and implement an electronic dictionary with definitions for motivated words based on derivation features in the form of a mobile application. The theoretical part deals with the issue of Czech word formation -- the main synchronous approaches are introduced and the onomasiological theory of word formation is described, on which the resulting tool is built. In the analytical part is described the process of creating dictionary definitions and analyzed the design together with the implementation of the mobile application. The tool uses freely accessible data from the DeriNet derivation network and its primary purpose is to serve as a support tool for teaching Czech as a second language.
...
\include{tex/uvod}
\include{tex/1-tvoreni-slov}
\include{tex/2-onomaz-teorie}
\include{tex/3-nastroje}
\include{tex/4-sufixy}
