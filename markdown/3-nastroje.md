...
Dalším způsobem, pomocí kterého šlo určovat derivační vztahy, byla extrakce z morfologického slovníku MorfLex CZ -- ten obsahuje 120 milionů trojic tvořených lemmatem, morfologickou značkou a slovním tvarem, příkladem může být trojice ‒ `žížnivý_,n; AAFS6----3N----; nejnežížnivější` \parencite{morflex}. Jak je z příkladu patrné, slovník obsahuje informace určené primárně pro flektivní morfologii, nicméně .... \parencite{sevcikova16} 
