...
význam obecnější
(např.\emph{vnímatel}\footnote{Význam slova vnímatel je dle SSJČ „kdo uvědoměle vnímá umělecké dílo“~\parencite{ssjc}, zde došlo prokazatelně do určité míry k~lexikalizaci slovotvorného významu.}).
...
definicí „someone who builds (feminine)``.
