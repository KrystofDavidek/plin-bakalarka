...
\rigtharrow \emph{zastupitel}) a~názvy osob, pro které je daná
činnost typická, ale nejsou označovány za samostatné profese.
(\emph{chovat} \rigtharrow \emph{chovatel}). Navíc je možné
...
slovotvornou bázi a~formant/y, například \emph{učitel} \rigtharrow
...
v~neprefigované podobě ve dvou předchozích slovotvorných krocích, mějme
  například řetězec \emph{pracovat} (2. krok) \rigtharrow
  \emph{\textbf{z}pracovat} (1. krok) \rigtharrow
...
u~jedné slovesné formy, příkladem může být řetězec \emph{pracovat}
  \rigtharrow \emph{zpracovat} (2. krok) \rigtharrow
  \emph{zpraco\textbf{vá}vat} (1. krok) \rigtharrow
...
\item
  ...
  sekundární imperfektivum, například \emph{myslit} \rigtharrow
...
\item
  ...
  \rigtharrow Je prefigované?

  \begin{itemize}
  \tightlist
  \item
    ne \rigtharrow „ten, kdo .*uje``
  \item
    ano
    ...
    \item
      ...
      \rigtharrow „ten, kdo .*oval nebo .*uje``
    \item
      Existuje ve slovotvorném řetězci sloveso ve tvaru .*it nebo .*nout
      nebo .*{[}aá{]}t? \rigtharrow „ten, kdo .*uje``
    \end{itemize}
  \end{itemize}
\item
  .*chovatel \rigtharrow Je prefigované?

  \begin{itemize}
  \tightlist
  \item
    ne \rigtharrow „ten, kdo .*á``
  \item
    ano \rigtharrow „ten, kdo .*ten, kdo .*al nebo .*á``
  \end{itemize}
\item
  {[}\^{}o{]}*{[}iíyýaá{]}vatel \rigtharrow „ten, kdo
  .*{[}íýá{]}vá``
\item
  {[}\^{}o{]}*ěvatel \rigtharrow „ten, kdo .*ívá``
\item
  .*itel \rigtharrow Je prefigované?
  ...
  \item
    ...
    \tightlist
    \item
      Je sloveso ve tvaru .*u.it? \rigtharrow „ten, kdo .*u.í``
    \item
      Je sloveso ve tvaru {[}\^{}u{]}*{[}eěi{]}t? \rigtharrow „ten,
      kdo .*í``
    \item
      Je sloveso ve tvaru .*u.ovat a~existuje zároveň ve slovotvorném
      řetězci sloveso ve tvaru .*ou.it? \rigtharrow „ten, kdo
      .*ou.il nebo .*ou.í``
    \end{itemize}
  \item
    ano
    ...
    \item
      ...
      \rigtharrow „ten, kdo .*ou.il nebo .*ou.í``
    \item
      Existuje ve slovotvorném řetězci sloveso ve tvaru .*ovat a~zároveň
      v~řetězci neexistuje sloveso ve tvaru .*it? \rigtharrow „ten,
      kdo .*oval``
    \item
      Je sloveso ve tvaru .*{[}eě{]}t? \rigtharrow „ten, kdo
      .*{[}eě{]}l nebo .*í``
    \item
      Je sloveso ve tvaru .*{[}\^{}ou{]}.*it \rigtharrow „ten, kdo
      .*il nebo .*í``
    \end{itemize}
  \end{itemize}
\item
  ...
  \item
    ne \rigtharrow „ten, kdo .*á``
  \item
    ano \rigtharrow „ten, kdo .*al nebo .*á``
  \end{itemize}
\item
  .*zatel \rigtharrow Je prefigované?

  \begin{itemize}
  \tightlist
  \item
    ne \rigtharrow „ten, kdo .*že``
  \item
    ano \rigtharrow ten, kdo .*zal nebo .*že``
  \end{itemize}
\item
  .*batel \rigtharrow Je prefigované?

  \begin{itemize}
  \tightlist
  \item
    ne \rigtharrow „ten, kdo .*bá`` (.*be)
  \item
    ano \rigtharrow „ten, kdo .*bal nebo .*bá`` (.*be)
  \end{itemize}
\item
  p{[}ií{]}satel \rigtharrow Je prefigované?

  \begin{itemize}
  \tightlist
  \item
    ne \rigtharrow „ten, kdo píše``
  \end{itemize}
\end{itemize}
