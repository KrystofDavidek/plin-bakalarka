...
a~lexikální „ten, kdo šije šaty``. Nicméně existují i~případy, u~nichž se
oba typy významu rovnají (například u~slova \emph{učitel}) anebo kdy je
strukturní význam oproti lexikálnímu obecnější. Například výraz
\emph{vnímatel}, jehož význam je v~SSJČ definován „ten, kdo uvědoměle
vnímá umělecké dílo``~\parencite{ssjc}, má lexikální význam užší než
strukturní, protože ten zní „ten, kdo vnímá``. Poslední případem je
situace, kdy je obecnější význam lexikální. Tento případ můžeme
demonstrovat slovem \emph{truhlář}, které má lexikální význam „ten, kdo
vyrábí dřevěný nábytek, dřevěné části staveb, jako okna, dveře ap.``
\parencite{ssjc}, a~strukturální význam „ten, kdo vyrábí truhly`` je tak
oproti lexikálními užší.
...
Lexikální význam zjistíme zase z~výkladového slovníku, navíc zde ale
můžeme identifikovat i~význam slovotvorný, který je dán určitým afixem,
v~tomto případě sufixem \emph{-natý}, který je ve slovníku afixu
definován takto: „mající v~hojné míře to, co označuje základové
substantivum``~\parencite{simandl2016}.
