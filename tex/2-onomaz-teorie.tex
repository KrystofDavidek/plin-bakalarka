...
zkráceno) oproti slovu základovém.~\parencite{enc-slovot-vyznam17}
...
strukturní význam oproti lexikálnímu užší (Např. výraz \emph{vnímatel},
jehož definice je v~SSJČ „ten, kdo uvědoměle vnímá umělecké dílo``
/parencite\{ssjc\}, zde je tedy lexikální význam obecnější než
strukturní „ten, kdo vnímá``.).
...
zákonitostí určitého jazyka utřídit, zobecnit nebo naopak konkretizovat.
Tyto onomaziologické kategorie se pak vzájemně odlišují podle
jednotlivých pojmenovávacích vlastností a~přístupů.
