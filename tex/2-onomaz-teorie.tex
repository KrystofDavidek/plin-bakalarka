...
a~lexikální „ten, kdo šije šaty``. Nicméně existují i~případy, v~nichž se
...
význam obecnější (například slovo \emph{truhlář}, jehož lexikální význam
je „ten, kdo vyrábí dřevěný nábytek, dřevěné části staveb, jako okna,
dveře ap.``~\parencite{ssjc}, strukturální význam „ten, kdo vyrábí
truhly`` je tak oproti lexikálními užší).
