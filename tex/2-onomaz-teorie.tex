...
\item
  ...
  charakteristiky (\emph{vinný} \rightarrow *ne-vinný\emph{), pouze
u~verb může a~nemusí prefixace měnit slovesný vid (imperfektivum }dělat*
  --\textgreater{} perfektivum \emph{dodělat}, ale imperfektivum
  \emph{dělávat} --\textgreater{} imperfektivum \emph{dodělávat});
\item
