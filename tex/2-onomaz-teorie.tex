...
Vztah motivace mezi dvěma slovy je pak především určité významové
odvozenosti, tedy že základové slovo (motivující) sémanticky předurčuje
slovo motivované, jehož význam lze takto ozřejmit.
\parencite[96]{dokulil00} Příklad motivace může být na výraz
...
je lze popsat významem slova motivujícího. Výrazy, které tuto vlastnost
nemají (\emph{dát}) pak definujeme jako značková.
...
\textless{}--\textgreater{} \emph{jabloň}).~\parencite[96]{dokulil00}
