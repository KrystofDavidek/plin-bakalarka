...
význam obecnější (například slovo \emph{truhlář} má lexikální význam
„ten, kdo vyrábí dřevěný nábytek, dřevěné části staveb, jako okna, dveře
ap.``~\parencite{ssjc}, strukturální význam „ten, kdo vyrábí truhly`` je
tak oproti lexikálními užší).
