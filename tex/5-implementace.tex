...
Výhodou tohoto objektového přístupu je fakt, že se na jednotlivých jasně
otypovaných místech v~kódu provádí pouze jeden specifický úkol, a~tím je
do určité míry zajištěna robustnost celkové aplikace, kdy je při výpadku
jedné ze služeb/funkce jednoduché lokalizovat místo chyby.
