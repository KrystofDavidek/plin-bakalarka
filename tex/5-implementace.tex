...
zaměříme a~pro demonstraci algoritmu použijeme přiložené schéma (viz
obrázek \ref{algoritmus}. V~prvé řadě musí aplikace nějakým způsobem
získat vstup pro analýzu, existují dva způsoby jak k~tomu docílit -- buď
využít rejstřík zpracovaných slov nebo ručně vepsat zadané slovo.
Stránka tedy vždy po nahrání kontroluje, zda nemá očekávat vstup
z~komponenty.
