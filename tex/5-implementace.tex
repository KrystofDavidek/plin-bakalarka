...
\textbackslash{}begin\{figure\}{[}ht{]} \centering
\textbackslash{}subfloat\{\includegraphics[width=0.4\textwidth]{{1-1}\label{1-1}}
\hfill
\textbackslash{}subfloat\{\includegraphics[width=0.4\textwidth]{{1-2}\label{1-2}}
