...
systém odkazů si lze tak modelovat do formy orientovaného grafu, jehož
uzly jsou pak jednotlivá lemmata (základní slovní tvary) a~hrany spolu
s~jejich orientací reprezentují určitý odvozovací proces. Jelikož má
v~této derivační síti každé odvozené slovo odkaz pouze na jedno slovo
...
skutečností, které ovlivnili výslednou podobu Derinetu -- primárně šlo
o~problematiku výběru původních lexémů, zde existovali dvě varianty, buď
...
lexémy z~korpusu. Druhou otázkou bylo, jaký typ slovotvorného vztahu by
