...
vyznačen derivační vztah. Tento formát si můžeme ilustrovat např. na
derivačním řetězci \emph{žít} $\rightarrow$ \emph{užít}
$\rightarrow$ \ldots{} $\rightarrow$ \emph{uživatel}, v~této formě
DeriNetu je reprezentován pěti záznamy, které jsou vzájemně propojeny
